...
<body id="page-top">
            ...
            <li class="nav-item">
                ...
                <div id="collapsePages" class="collapse" aria-labelledby="headingPages" data-parent="#accordionSidebar">
                    ...
                    <a class="collapse-item" href="../Royal Global/admin_review.php">Royal Global Hotel</a>
                        ...
                        <a class="collapse-item" href="admin_review.php">Avicenna Hotel</a>
    ...
    <div class="card shadow mb-4">
                ...
                <thead>
                    ...
                    <tbody>
                    <?php 
$data_royal     = mysqli_query($koneksi, "select * from fasilitas_avicenna");
$data_hotel   = mysqli_query($koneksi, "select * from fasilitas_avicenna");
