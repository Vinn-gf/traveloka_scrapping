            ...
            <li class="nav-item">
                ...
                <div id="collapsePages" class="collapse" aria-labelledby="headingPages" data-parent="#accordionSidebar">
                    ...
                    <a class="collapse-item" href="../Royal Global/admin_review.php">Royal Global Hotel</a>
                        ...
                        <a class="collapse-item" href="admin_review.php">Batu Suli Hotel</a>
                </div>
            </li>
            <!-- Nav Item - Tables -->
            ...
            <div id="content">
                ...
                <div class="container-fluid">
                    ...
                    <div class="card shadow mb-4">
                        ...
                        <h6 class="m-0 font-weight-bold text-primary" style="padding: 0px 12px;"><a href="#">Batu Suli Hotel</a></h6>
                        </div>
                        <section class="s1">
    <div class="card shadow mb-4">
