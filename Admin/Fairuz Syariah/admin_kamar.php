...
<body id="page-top">
    ...
    <div class="card shadow mb-4">
                ...
                <thead>
                    ...
                    <tbody>
                    <?php 
$data_royal     = mysqli_query($koneksi, "select * from kamar_fairuzsyariah");
$data_hotel   = mysqli_query($koneksi, "select * from kamar_fairuzsyariah");
while($data = mysqli_fetch_array($data_hotel)){
            ?>
                <tr>
                    ...
                    <td>
						<a href="delete_kamar.php?nomor=<?= $data['nomor']; ?>" class="btn btn-sm btn-danger" onclick="return confirm('Anda yakin ingin menghapus data ini?');">Hapus</a>
					</td>
                </tr>
                <?php
}
