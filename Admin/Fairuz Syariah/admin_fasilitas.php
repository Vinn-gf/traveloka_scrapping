        ...
        <ul class="navbar-nav bg-gradient-primary sidebar sidebar-dark accordion" id="accordionSidebar">
            ...
            <li class="nav-item">
                ...
                <div id="collapsePages" class="collapse" aria-labelledby="headingPages" data-parent="#accordionSidebar">
                    ...
                    <a class="collapse-item" href="../Royal Global/admin_review.php">Royal Global Hotel</a>
                        <a class="collapse-item" href="admin_review.php">Fairuz Syariah Hotel</a>
            ...
            <div id="content">
                ...
                <div class="container-fluid">
                    ...
                    <div class="card shadow mb-4">
                        ...
                        <h6 class="m-0 font-weight-bold text-primary" style="padding: 0px 12px;"><a href="#">Fairuz Syariah Hotel</a></h6>
                        </div>
                        <section class="s1">
    <div class="card shadow mb-4">
                ...
                <thead>
                    ...
                    <tbody>
                    <?php 
$data_royal     = mysqli_query($koneksi, "select * from fasilitas_fairuzsyariah");
$data_hotel   = mysqli_query($koneksi, "select * from fasilitas_fairuzsyariah");
while($data = mysqli_fetch_array($data_hotel)){
            ?>
                <tr>
                    ...
                    <td>
						<a href="delete_fasilitas.php?nomor=<?= $data['nomor']; ?>" class="btn btn-sm btn-danger" onclick="return confirm('Anda yakin ingin menghapus data ini?');">Hapus</a>
					</td>
                </tr>
                <?php
}
