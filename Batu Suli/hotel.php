...
$ambildata = mysqli_query($koneksi,"select * from review_batusuli");
?>
<!DOCTYPE html>
<html>

<head>
	<title>Scrapping Batu Suli</title>
...
<body>
    ...
    <div class="card shadow mb-4">
                        ...
                        <h6 class="m-0 font-weight-bold text-primary" style="padding: 0px 12px;"><a href="../Beranda/home.php">Batu Suli Hotel</a></h6>
                ...
                <thead>
                    ...
                    <tbody>
                    <?php 
$data_suli     = mysqli_query($koneksi, "select * from review_batusuli");
$data_hotel   = mysqli_query($koneksi, "select * from review_batusuli");
