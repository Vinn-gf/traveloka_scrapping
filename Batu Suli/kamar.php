...
<body>
    ...
    <div class="card shadow mb-4">
                ...
                <thead>
                    <tr>
                        <th>KAMAR TIDAK TERSEDIA</th>
                        </tr>
                    </thead>
                    <tbody>
                    <!-- <?php 
$data_nilai     = mysqli_query($koneksi, "select * from kamar_fairuzsyariah");
$data_siswas   = mysqli_query($koneksi, "select * from kamar_fairuzsyariah");
while($data = mysqli_fetch_array($data_siswas)){
            ?>
                <tr>
