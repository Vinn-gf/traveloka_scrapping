...
$ambildata = mysqli_query($koneksi,"select * from review_fairuzsyariah");
?>
<!DOCTYPE html>
<html>

<head>
	<title>Scrapping Fairuz Syariah </title>
...
<body>
    ...
    <div class="card shadow mb-4">
                        ...
                        <h6 class="m-0 font-weight-bold text-primary" style="padding: 0px 12px;"><a href="../Beranda/home.php">Fairuz Syariah Hotel</a></h6>
                ...
                <thead>
                    ...
                    <tbody>
                    <?php 
$data_fairuz     = mysqli_query($koneksi, "select * from review_fairuzsyariah");
