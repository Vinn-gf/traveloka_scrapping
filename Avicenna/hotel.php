...
<body>
    ...
    <div class="card shadow mb-4">
                        ...
                        <h6 class="m-0 font-weight-bold text-primary" style="padding: 0px 12px;"><a href="../Beranda/home.php">Avicenna Hotel</a></h6>
                ...
                <thead>
                    ...
                    <tbody>
                    <?php 
$data_avicenna = mysqli_query($koneksi, "select * from review_avicenna");
